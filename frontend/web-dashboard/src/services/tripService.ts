...
export interface Trip {
  ...
  notes?: string | null;
  customer_id?: string;
  customer?: { id: string; name: string; avatar_url?: string | null; logo_url?: string | null; primary_contact_person?: string | null; contact_phone: string; whatsapp_number?: string; whatsapp_group_link?: string; whatsapp_group_name?: string };
