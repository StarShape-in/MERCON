    ...
    },
    {
      ...
      accessor: () => (
        <div className="flex gap-1">
          <button className="w-7 h-7 rounded-lg bg-[#F5F5F7] hover:bg-[#EBEBEF] flex items-center justify-center transition-colors">
            <Edit2 size={13} className="text-[#6E6E80]" />
          </button>
          <button className="w-7 h-7 rounded-lg bg-[#FEF2F2] hover:bg-[#FEE2E2] flex items-center justify-center transition-colors">
          ...
          <div className="p-5 border-b border-black/[0.04] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="relative max-w-xs w-full">
              ...
              <input 
                ...
                className="w-full bg-[#F9F9FB] border border-black/[0.05] rounded-xl pl-9 pr-4 py-2 text-xs outline-none focus:bg-white focus:border-[#E8450F] transition-all"
              />
            </div>
          </div>
