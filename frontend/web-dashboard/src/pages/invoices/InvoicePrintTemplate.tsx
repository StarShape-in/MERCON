  ...
  return (
    <div className="bg-white min-h-screen font-sans text-[#111]">
      <div className="max-w-4xl mx-auto p-10 bg-white" style={{ width: '210mm', minHeight: '297mm' }}>
        ...
        {/* Header */}
        <div className="flex justify-between items-start border-b-2 border-[#E8450F] pb-6 mb-8 overflow-hidden">
          <div className="pt-2 pl-2">
            <img src="/invoice-logo.png" alt="MERCON Logo" className="h-40 w-auto mb-2 object-contain scale-[1.3] origin-top-left" />
