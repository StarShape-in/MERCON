      ...
      <div className="px-6 pb-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-black/[0.08] rounded-2xl p-5 shadow-sm sticky top-24">
              ...
              <form onSubmit={handleUpload} className="space-y-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-[#F5F5F7] border border-transparent rounded-xl px-4 py-2.5 text-sm font-medium text-[#111] outline-none"
                  >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full text-sm font-medium file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-[#E8450F]/10 file:text-[#E8450F] hover:file:bg-[#E8450F]/20 cursor-pointer text-[#6E6E80]"
                    required
                  />
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-black/[0.08] rounded-2xl shadow-sm overflow-hidden min-h-[400px]">
              ...
              {isLoadingDocs ? (
                ...
                <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {documents.map((doc) => {
                    ...
                    return (
                      <div key={doc.id} className="border border-black/[0.06] rounded-xl p-4 hover:shadow-sm transition-shadow relative bg-[#F9F9FB]">
