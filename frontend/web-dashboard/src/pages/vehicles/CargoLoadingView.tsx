        ...
        <div className="xl:col-span-9 flex flex-col justify-between gap-3.5 h-full overflow-hidden">
          ...
          <div className="w-full relative flex items-center justify-center shrink-0 overflow-hidden">
            ...
            <div className="relative w-full max-w-6xl xl:max-w-7xl mx-auto">
              ...
              {/* Framed Default Light HUD Overlay inside Trailer (Perfectly Fitted inside White Body) */}
              <div className="absolute top-[11.8%] left-[29.8%] w-[65.8%] h-[50.8%] bg-slate-100/95 backdrop-blur-sm text-slate-900 rounded-2xl p-2 sm:p-2.5 border border-slate-300/80 shadow-md flex items-stretch gap-2 sm:gap-2.5 overflow-hidden pointer-events-auto">
                
                {/* ── LEFT SUB-CARD: Odometer & Service Progress ── */}
                <div className="w-[32%] bg-white rounded-xl p-2 sm:p-2.5 flex flex-col justify-between border border-slate-200/90 shadow-2xs shrink-0 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[8px] text-slate-400 font-semibold leading-none mt-0.5 truncate">Total Distance</p>
                      </div>
                    </div>

                    <Badge className="bg-emerald-100 text-emerald-700 border border-emerald-200 font-extrabold px-1.5 py-0.2 text-[8px] rounded-full shadow-none flex items-center gap-1 shrink-0">
                  ...
                  <div className="my-auto py-0.5">
                    <div className="bg-slate-900 p-1.5 rounded-lg border border-slate-800 shadow-inner flex items-center justify-center gap-1">
                      <div className="flex items-center gap-0.5">
                        {(() => {
                          ...
                          return digitArray.map((digit, idx) => (
                            <div
                              key={idx}
                              className="relative w-3.5 h-5.5 sm:w-4 sm:h-6 bg-gradient-to-b from-[#0A120E] via-[#17261F] to-[#0A120E] text-white font-mono font-black text-[10.5px] sm:text-xs rounded-md border border-slate-700 shadow-[inset_0_2px_4px_rgba(0,0,0,0.9)] flex items-center justify-center overflow-hidden shrink-0 select-none"
                            >
                      ...
                      <span className="text-[10px] sm:text-[11px] font-black text-slate-200 ml-0.5 shrink-0">
                        km
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50/90 border border-slate-200/90 rounded-lg p-1.5 sm:p-2 space-y-1 shrink-0">
                    <div className="flex justify-between items-center text-[8.5px]">
                      <div className="flex items-center gap-1">
                        ...
                        <div>
                          <p className="text-[7.5px] text-slate-400 font-extrabold uppercase leading-none">Next Due</p>
                          <p className="text-[10px] sm:text-[11px] font-black text-emerald-600 leading-tight mt-0.5">in 7,500 km</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-[7.5px] text-slate-400 font-extrabold uppercase leading-none">Target</p>
                        <p className="text-[10px] font-black text-slate-900 leading-tight mt-0.5">150,000 km</p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-[7.5px] text-slate-400 font-semibold">
                ...
                {/* ── RIGHT SUB-CARD: Vehicle Service History (Clean Flex Layout, Zero Truncation) ── */}
                <div className="flex-1 bg-white rounded-xl p-2 sm:p-2.5 flex flex-col justify-between min-w-0 border border-slate-200/90 shadow-2xs overflow-hidden">
                  ...
                  <div className="flex items-center justify-between shrink-0 pb-1 border-b border-slate-100">
                    <div className="flex items-center gap-1.5 min-w-0">
                      <div className="w-5 h-5 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-700 shadow-2xs shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-[8px] text-slate-400 font-semibold leading-none mt-0.5">Recent maintenance records</p>
                      </div>
                    </div>

                    <span className="text-[8.5px] font-mono font-bold text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.2 rounded-full shrink-0">
                      {serviceRecords.length} Records
                    </span>
                  </div>

                  {/* Table Header Bar */}
                  <div className="flex items-center justify-between bg-slate-100/90 px-2.5 py-0.5 rounded-md text-[8.5px] font-extrabold text-slate-500 uppercase tracking-wider shrink-0 my-0.5 border border-slate-200/60">
                  ...
                  {/* Service History Rows (Max 3 items, Perfectly Spaced) */}
                    ...
                    {serviceRecords.slice(0, 3).map((rec, idx) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center justify-between px-2.5 py-1 rounded-lg bg-slate-50/80 border border-slate-200/80 hover:border-slate-300 hover:bg-slate-100/80 transition-all cursor-pointer shrink-0 gap-2"
                        >
                          ...
                          <div className="flex-1 flex items-center gap-2 min-w-0">
                            ...
                            <div className="min-w-0">
                              <p className="font-black text-slate-900 text-[10.5px] sm:text-[11px] truncate leading-tight">{rec.work_done}</p>
                              <p className="text-[8px] font-medium text-slate-500 truncate mt-0.5">{rec.workshop_name}</p>
                            </div>
                          </div>

                          {/* Date */}
                          <div className="w-24 text-center text-[9.5px] font-bold text-slate-600 whitespace-nowrap shrink-0">
                            {rec.service_date}
                          </div>

                          {/* Odometer */}
                          <div className="w-24 text-right text-[10.5px] font-black text-slate-900 whitespace-nowrap shrink-0">
                  ...
                  <div className="pt-0.5 border-t border-slate-200/80 flex items-center justify-between text-[8px] font-mono uppercase text-slate-400 shrink-0">
