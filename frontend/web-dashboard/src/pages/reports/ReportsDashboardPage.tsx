      ...
      <DashboardLayout active="Reports" title="Reports & Analytics">
        <div className="p-6">
          <div className="animate-pulse grid grid-cols-4 gap-4 mb-6">
            {[1, 2, 3, 4].map(i => <div key={i} className="h-28 bg-black/5 rounded-2xl"></div>)}
          </div>
          <div className="animate-pulse h-96 bg-black/5 rounded-2xl"></div>
        </div>
      </DashboardLayout>
    );
  }
    ...
    >
      <div className="px-6 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="lg:col-span-2 bg-white border border-black/[0.08] rounded-2xl p-6 shadow-sm">
          ...
          <div className="bg-white border border-black/[0.08] rounded-2xl p-6 shadow-sm flex flex-col">
        ...
        {/* Compliance Row */}
        <div className="bg-white border border-black/[0.08] rounded-2xl p-6 shadow-sm flex items-center justify-between">
