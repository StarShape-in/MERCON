...
export default function AddCustomerPage() {
  ...
  return (
    <DashboardLayout active="Customers" title="Onboard Customer">
      <div className="px-4 sm:px-6 pb-8 space-y-5 animate-fade-in max-w-[1440px] mx-auto">
        
        {/* Top Header & Scope Specification */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-3 border-b border-slate-200 dark:border-slate-800">
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700 shadow-2xs">
            ...
            <Badge className="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold dark:bg-indigo-950/40 dark:text-indigo-300 dark:border-indigo-800 px-2.5 py-1">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Btn 
              ...
              className="h-9 gap-1.5 text-xs bg-[#E8450F] hover:bg-[#d03d0c] text-white font-bold shadow-sm rounded-lg px-4"
        ...
        <div className="flex items-center justify-between gap-3 p-3 bg-gradient-to-r from-orange-50/70 via-indigo-50/40 to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/60 rounded-xl border border-orange-200/60 dark:border-slate-800">
          <div className="flex items-center gap-2">
            <Sparkles className="w-4 h-4 text-[#E8450F] animate-pulse shrink-0" />
            <span className="text-xs font-bold text-slate-800 dark:text-slate-200">1-Click Account Presets:</span>
          </div>
        ...
        {/* Top Instrument Panel Summary & Progress Bar Card */}
        <Card className="border border-slate-200 dark:border-slate-800 shadow-xs rounded-xl overflow-hidden bg-white dark:bg-slate-900">
          <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4 divide-y md:divide-y-0 md:divide-x divide-slate-100 dark:divide-slate-800">
            {/* Metric 1: Client Identity */}
            <div className="flex items-center gap-3 pr-2">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-orange-100 text-[#E8450F] dark:bg-orange-950/50 dark:text-orange-400 shrink-0">
                <Building2 className="w-5 h-5" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] uppercase tracking-wider font-extrabold text-slate-400">Client Identity</span>
                ...
                <span className="text-[11px] text-slate-500 truncate block">
                  {formData.industry} • {formData.company_tier}
                </span>
              </div>
            </div>

            {/* Metric 2: Contact Details */}
            <div className="flex items-center gap-3 md:pl-4 pr-2 pt-3 md:pt-0">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-blue-100 text-blue-600 dark:bg-blue-950/50 dark:text-blue-400 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-bold truncate mt-0.5 text-slate-900 dark:text-slate-100 font-mono">
                  {formData.contact_phone.trim() ? `+966 ${formData.contact_phone}` : 'No Phone Specified'}
                </p>
                <span className="text-[11px] text-slate-500 truncate block font-mono">
                  {formData.email.trim() || 'No Email Specified'}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:pl-4 pr-2 pt-3 md:pt-0">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-emerald-100 text-emerald-600 dark:bg-emerald-950/50 dark:text-emerald-400 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-[11px] text-slate-500 truncate block">
                  {formData.payment_terms} • {formData.billing_cycle}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:pl-4 pt-3 md:pt-0">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-indigo-100 text-indigo-600 dark:bg-indigo-950/50 dark:text-indigo-400 shrink-0">
                <MapPin className="w-5 h-5" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] uppercase tracking-wider font-extrabold text-slate-400">Default Route SLA</span>
          ...
          <div className="px-4 py-2 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 text-[11px] font-semibold text-slate-500">
              <span>{filledCount} of {completionFields.length} key fields</span>
            </div>
          </div>
        </Card>
        ...
        <div className="max-w-5xl mx-auto w-full pt-1">
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-xl shadow-xs overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-base font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                      Customer Entity Registration & SLA Setup
                    </CardTitle>
                    <CardDescription className="text-xs text-slate-500 mt-0.5">
                      Configure company identity, CR registration, contact personnel, credit SLA, and logistics parameters.
                    </CardDescription>
                  </div>
                </div>
