  ...
  const handleReset = () => {
    if (customer) {
      setFormData({
        ...
        vat_number: customer.tax_number || '',
        contact_phone: customer.contact_phone || customer.phone || '',
        whatsapp_number: (customer as any).whatsapp_number || '',
        whatsapp_group_link: (customer as any).whatsapp_group_link || '',
        whatsapp_group_name: (customer as any).whatsapp_group_name || '',
        email: '',
        billing_address: '',
        credit_limit: customer.credit_limit !== undefined ? String(customer.credit_limit) : '100000',
        payment_terms: customer.payment_terms || 'Net 30',
