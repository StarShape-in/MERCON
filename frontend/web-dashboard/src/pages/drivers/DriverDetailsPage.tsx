            ...
            <form onSubmit={handleDelete} className="p-6">
              <div className="mb-6">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-black/[0.08] rounded-none px-4 py-2.5 text-sm outline-none focus:border-red-500 transition-all"
              ...
              <div className="flex justify-end gap-3">
                ...
                <button 
                  ...
                  className="bg-red-600 text-white text-xs font-bold px-4 py-2 rounded-none hover:bg-red-700 transition-colors flex items-center justify-center min-w-[100px]"
                >
