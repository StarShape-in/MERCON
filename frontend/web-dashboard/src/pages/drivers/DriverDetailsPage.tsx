      ...
      <DashboardLayout active="Drivers" title="Driver Details">
        <div className="p-6">
          <div className="animate-pulse flex flex-col gap-6">
            <div className="h-20 bg-black/5 rounded-lg"></div>
  ...
  return (
    ...
    >
      <div className="px-6 pb-6 max-w-5xl">
        ...
        {/* Header Profile Card */}
        <div className="bg-white border border-black/[0.08] rounded-lg p-6 mb-6 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between shadow-sm">
          ...
          <div className="flex flex-wrap gap-4 md:gap-8 bg-[#F5F5F7] p-4 rounded-lg border border-black/[0.04]">
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            ...
            <div className="bg-white border border-black/[0.08] rounded-lg p-5 shadow-sm">
              ...
              <button 
                onClick={() => navigate(`/drivers/${driver.id}/documents`)}
                className="w-full mt-4 py-2 bg-white border border-[#E8450F] text-[#E8450F] text-xs font-bold rounded-lg hover:bg-[#E8450F]/5 transition-colors"
              >
                Manage Documents
              </button>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-black/[0.08] rounded-lg shadow-sm overflow-hidden flex flex-col h-full">
            ...
            <form onSubmit={handleDelete} className="p-6">
              <div className="mb-6">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-black/[0.08] rounded-lg px-4 py-2.5 text-sm outline-none focus:border-red-500 transition-all"
              ...
              <div className="flex justify-end gap-3">
                ...
                <button 
                  ...
                  className="bg-red-600 text-white text-xs font-bold px-4 py-2 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center min-w-[100px]"
                >
