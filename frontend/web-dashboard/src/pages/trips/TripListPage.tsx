...
import { Download, Plus, Edit2, MapPin, Navigation, Truck, Trash2 } from 'lucide-react';
        ...
        <div className="flex gap-1">
          ...
          {row.status === 'InTransit' && (
            <button 
              ...
              className="w-7 h-7 rounded-none bg-[#E8450F]/10 hover:bg-[#E8450F]/20 flex items-center justify-center transition-colors"
              title="Track Live"
            >
        ...
        <DataTable
          ...
          filterElement={
            <select
              ...
              className="text-xs font-semibold bg-white border border-black/[0.07] px-3 py-2 rounded-none outline-none"
            >
