    ...
    >
      <div className="px-6 pb-6 grid grid-cols-1 lg:grid-cols-3 gap-5 animate-fade-in">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Trip Summary Card */}
          <div className="bg-[#1C1C2E] rounded-2xl p-5 border border-white/5 shadow-lg relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 mt-6 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-2 text-center max-w-[180px]">
                ...
                <div className="px-3 py-2 rounded-xl bg-white/5 border border-white/10 col-span-2">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-5 border border-black/[0.06] shadow-sm">
            ...
            {trip.payment_status === 'Approved' ? (
              <div className="bg-[#F0FDF4] text-[#16A34A] border border-[#16A34A]/10 p-3 rounded-xl">
