...
import {
  ...
  UploadCloud, ExternalLink, Timer, Route,
} from 'lucide-react';
          ...
          <Card className="rounded-2xl border-black/[0.06] shadow-sm bg-white">
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                <div>
                  <p className="text-[8px] text-[#9898A4] font-bold uppercase tracking-wider">Planned Start</p>
                  <p className="text-[11px] font-bold text-[#111] mt-1">
                    {trip.planned_start ? new Date(trip.planned_start).toLocaleString() : '—'}
                  </p>
                </div>
                <div>
                  <p className="text-[8px] text-[#9898A4] font-bold uppercase tracking-wider">Actual Start</p>
                  <p className="text-[11px] font-bold text-[#111] mt-1">
                    {trip.actual_start ? new Date(trip.actual_start).toLocaleString() : '—'}
                  </p>
                </div>
                <div>
                  <p className="text-[8px] text-[#9898A4] font-bold uppercase tracking-wider">Actual End</p>
                  <p className="text-[11px] font-bold text-[#111] mt-1">
