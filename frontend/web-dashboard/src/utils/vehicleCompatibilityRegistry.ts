...
const DEFAULT_RULES: VehicleCompatibilityRule[] = [
  {
    ...
    allowedVehicleClassCodes: ['3-4 TON'],
    isActive: true,
  ...
  },
  {
    ...
    allowedVehicleClassCodes: ['5 TON'],
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    allowedVehicleClassCodes: ['10 TON'],
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    allowedVehicleClassCodes: ['20 TON'],
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    allowedVehicleClassCodes: ['40 FEET'],
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
