  ...
  return (
    <div className="shrink-0 bg-white border-b border-black/[0.08] px-6 h-[88px] flex items-center gap-4 relative z-20">
      ...
      <Link to="/notifications" className="relative group">
        <div className="w-8 h-8 rounded-xl bg-[#F5F5F7] hover:bg-[#EBEBEF] flex items-center justify-center transition-colors">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-1.5 w-48 bg-white border border-black/[0.07] rounded-xl shadow-lg py-1.5 animate-fade-in origin-top-right">
