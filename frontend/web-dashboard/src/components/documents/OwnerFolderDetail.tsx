  ...
  return (
    <div className="h-full flex flex-col space-y-3 overflow-hidden">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-12 gap-4 h-full overflow-hidden">
        ...
        {/* LEFT SIDE COLUMN: 2-Box Stacked Layout (4 / 12 width) */}
        <div className="lg:col-span-4 flex flex-col justify-start space-y-4">
          {activeSlot ? (
            <>
              {/* 📦 BOX 1: Active Selected Document Details & Validity */}
              ...
              {/* 📦 BOX 2: OTHER VEHICLE DOCUMENTS (Separate Box Field) */}
              <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 sm:p-4.5 shadow-2xs flex flex-col space-y-3">
