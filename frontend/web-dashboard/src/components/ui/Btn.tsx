...
export default function Btn({
  ...
  const variantStyles: Record<BtnVariant, string> = {
    ...
    danger: 'bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300 border border-rose-200/80 dark:border-rose-800/80 hover:!bg-rose-100 dark:hover:!bg-rose-950/70 font-semibold rounded-md shadow-xs transition-all',
