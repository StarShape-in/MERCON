...
const DEFAULT_VEHICLE_DOCS = [
  { id: 'istimara', name: 'Istimara', status: 'Valid (15 Oct 2027)', icon: FileText, iconColor: 'text-[#2563EB]', strokeColor: '#CBD5E1', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-[#A7F3D0]', dotColor: 'bg-[#16A34A]', label: 'Valid (15 Oct 2027)' },
  { id: 'insurance', name: 'Insurance', status: 'Valid (10 Jan 2027)', icon: ShieldCheck, iconColor: 'text-[#7C3AED]', strokeColor: '#CBD5E1', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-[#A7F3D0]', dotColor: 'bg-[#16A34A]', label: 'Valid (10 Jan 2027)' },
  { id: 'operation_card', name: 'Operation Card', status: 'Expiring 28 Sep', icon: AlertTriangle, iconColor: 'text-[#EA580C]', strokeColor: '#CBD5E1', badgeBg: 'bg-amber-50', badgeText: 'text-amber-700', badgeBorder: 'border-amber-200', dotColor: 'bg-amber-500', label: 'Expiring 28 Sep' },
  { id: 'saso_plates', name: 'SASO Plates', status: 'Valid (04 Nov 2028)', icon: Award, iconColor: 'text-[#7C3AED]', strokeColor: '#CBD5E1', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-[#A7F3D0]', dotColor: 'bg-[#16A34A]', label: 'Valid (04 Nov 2028)' },
  { id: 'fahas', name: 'FAHAS', status: 'Valid (20 May 2027)', icon: CheckCircle2, iconColor: 'text-[#059669]', strokeColor: '#CBD5E1', badgeBg: 'bg-emerald-50', badgeText: 'text-emerald-700', badgeBorder: 'border-[#A7F3D0]', dotColor: 'bg-[#16A34A]', label: 'Valid (20 May 2027)' },
];
...
export default function DocumentsValidityFolder({ 
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 sm:p-5 shadow-2xs flex flex-col justify-between h-full min-h-[410px] max-h-[540px] relative overflow-hidden select-none">
      ...
      <div className="relative flex-1 flex flex-col justify-start pt-2 sm:pt-3 pb-1 min-h-0 overflow-y-auto pr-1.5">
        {isLoading ? (
