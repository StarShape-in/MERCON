...
export default function ReportsHeader({ 
  ...
  return (
    <div className="space-y-4 mb-4">
      ...
      <div className="bg-slate-100 dark:bg-slate-800 p-1.5 rounded-xl flex items-center gap-1 overflow-x-auto border border-slate-200/80 dark:border-slate-700/80">
        {tabs.map((tab) => {
          const Icon = tab.icon;
