                                  ...
                                  <div className="flex flex-col items-end gap-1">
                                    ...
                                    <div className="flex items-center gap-1">
                                      ...
                                      <input
                                        ...
                                        placeholder="e.g. 800"
                                        className="w-24 h-8 px-2.5 rounded-lg border border-slate-200 text-lg font-bold focus:outline-none focus:border-brand bg-white text-right shadow-2xs"
                                      />
                                    </div>
                                  </div>
                                  <div className="flex flex-col items-end gap-1">
                                    ...
                                    <div className="flex items-center gap-1">
                                      ...
                                      <input
                                        ...
                                        placeholder="e.g. 200"
                                        className="w-24 h-8 px-2.5 rounded-lg border border-slate-200 text-lg font-bold focus:outline-none focus:border-indigo-600 bg-white text-right shadow-2xs"
                                      />
                                    </div>
                                  </div>
                                </div>
