    ...
    <>
      <div className="p-3 rounded-xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs space-y-2.5 text-[#3E3C3D] dark:text-slate-100">
        ...
        <div className="pb-1 border-b border-slate-100 dark:border-slate-800">
          <h4 className="text-[11px] font-extrabold text-[#FA634E] uppercase tracking-wider flex items-center gap-1.5">
        ...
        <div className="pb-2 border-b border-slate-100 dark:border-slate-800/80 space-y-0.5">
          ...
          <div className="flex items-baseline justify-between font-mono">
            <span className="text-base font-extrabold text-[#3E3C3D] dark:text-white">
        ...
        <div className="pb-2 border-b border-slate-100 dark:border-slate-800/80 space-y-0.5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-[11px] font-bold text-[#FA634E] hover:text-[#FA634E]/90 flex items-center gap-1 cursor-pointer outline-none transition-colors"
            >
              <Plus className="w-3 h-3" />
              {chargeLines.length > 0 ? `Manage (${chargeLines.length})` : 'Add Charge'}
            </button>
          </div>
