  ...
  return (
    <div className="space-y-5 animate-fade-in py-2">
      <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-950/40 rounded-2xl border border-slate-200 dark:border-slate-800">
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Total Billing: <span className="font-bold text-slate-900 dark:text-slate-100">SAR {billingTotal.toLocaleString()}</span> across {selectedDatesCount} operating days.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-2xs flex flex-col justify-between">
          <div>
