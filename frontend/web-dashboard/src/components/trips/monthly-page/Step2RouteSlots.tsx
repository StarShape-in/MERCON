      ...
      <div className="flex items-center justify-between flex-wrap gap-3 border-b border-slate-200 dark:border-slate-800 pb-3">
        <div className="space-y-0.5">
          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
            ...
            Configure Route Locations & Trip Slots ({contractSlots.length})
          </h3>
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Select pickup/dropoff stops, intermediate locations, timing, and trip category.
          </p>
        </div>
            ...
            >
              ...
              {isRoundTrip ? (
                <div className="space-y-3">
                  {/* Outbound Leg */}
                  <div className="p-3 rounded-xl bg-slate-50/70 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  {/* Return Leg */}
                  <div className="p-3 rounded-xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-200 dark:border-indigo-800 space-y-2">
                    <Badge className="bg-indigo-600 text-white border-indigo-600 text-[10px] font-bold flex items-center gap-1">
                      <RefreshCw className="w-2.5 h-2.5" /> Leg 2: Return Journey (Closed Loop)
                    </Badge>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="space-y-1">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-purple-950 dark:text-purple-300 uppercase tracking-wider flex items-center justify-between">
                          ...
                          <Badge className="bg-emerald-50 text-emerald-800 border-emerald-200 font-bold text-[9px]">
                            <RotateCcw className="w-2.5 h-2.5 text-emerald-600 mr-0.5" /> Auto-Linked Home
                          </Badge>
                        </label>
                        <LocationCombobox
                          customerId={contractCustomer}
                          ...
                          placeholder="Search final home location..."
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {/* Pickup Card */}
                  <div className="rounded-xl border border-emerald-200/80 bg-emerald-50/30 dark:bg-emerald-950/20 overflow-hidden p-3 space-y-2">
                  ...
                  {/* Dropoff Card */}
                  <div className="rounded-xl border border-orange-200/80 bg-orange-50/30 dark:bg-orange-950/20 overflow-hidden p-3 space-y-2">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-orange-900 dark:text-orange-300 uppercase tracking-wider flex items-center gap-1">
                          <Clock className="w-3 h-3 text-brand" /> Dropoff Time *
                        </label>
                        <input
                          type="time"
