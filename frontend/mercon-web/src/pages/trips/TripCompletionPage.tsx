  ...
  return (
    ...
    >
      <div className="px-6 pb-6 max-w-2xl animate-fade-in">
        <div className="bg-white rounded-2xl border border-black/[0.06] p-5 shadow-sm mb-5">
        ...
        <FormSection title="Proof of Delivery & Closing Notes">
          <div className="col-span-2 flex flex-col gap-1.5">
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center flex flex-col items-center justify-center hover:bg-gray-50 transition-colors cursor-pointer relative">
              <input 
                type="file" 
