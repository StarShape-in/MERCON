...
-- 2. Upsert TripFinancials snapshot for TRP-0005 and TRP-0006
...
SET "quotationId" = EXCLUDED."quotationId",
    "applied_rate" = COALESCE("TripFinancials"."applied_rate", EXCLUDED."applied_rate"),
    "quotation_line_type" = COALESCE("TripFinancials"."quotation_line_type", EXCLUDED."quotation_line_type"),
    "quotation_billing_type" = COALESCE("TripFinancials"."quotation_billing_type", EXCLUDED."quotation_billing_type");
